...
import { timelineDataPandeiro } from '@/utils/Timeline';
...
export const Pandeiro = () => {
  ...
  return (
    <main className="w-full  h-auto min-h-svh">
      <Header />
      <BannerPage urlImage={Image} instrumetal='Pandeiro' />
        ...
        <div className='container mx-auto'>
          ...
          <div className="relative">
            ...
            <div className="flex flex-col md:flex-row md:flex-wrap">
              {timelineDataPandeiro.map((item, index) => (
                <Timeline
                  key={index}
                  title={item.title}
      ...
      <section className='w-[95%] h-auto container min-h-[30rem]
       bg-neutral-950 my-9 mx-auto rounded-xl p-8'>
        ...
        {
          registrationMade !== 'Sim' ? <FormCreateStudents instrument='Pandeiro' />
            : <AddInstrumentsStudentsForm instrument='Pandeiro' />
        }
      </section>
